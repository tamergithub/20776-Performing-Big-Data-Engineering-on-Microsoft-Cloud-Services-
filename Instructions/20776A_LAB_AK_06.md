...
7. In **Solution Explorer**, expand **CustomExtractors**, and then double-click **JsonExtractor.cs**.
...
10. In **Solution Explorer**, right-click **CustomExtractors**, and then click **Register Assembly**.
...
30. In the **New Project** dialog box, in the **Templates** list, expand **Azure Data Lake**, and then click **U-SQL**.
...
36. In the **Data explorer** blade, click **ConvertedSpeedData.csv**, to view the extracted data.
