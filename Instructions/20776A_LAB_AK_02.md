...
2. On the **Create storage account** blade, in the **Name** box, type **datastore&lt;_your name_&gt;&lt;_date_&gt;**.
3. Under **Resource group**, click **Use existing**, and then click **CamerasRG**.
4. In the **Location** list, select the same location as you used for the Data Lake Store.
5. Leave all other details at their defaults, and click **Create**.
6. Wait until the storage account has been successfully created before continuing with the lab.
7. Click **All resources**, and then click **datastore&lt;_your name_&gt;&lt;_date_&gt;**.
8. On the **datastore&lt;_your name_&gt;&lt;_date_&gt;** blade, under **BLOB SERVICE**, click **Blobs**.
9. On the **datastore&lt;_your name_&gt;&lt;_date_&gt; - Blobs** blade, click **+ Container**.
10. In the **New container** dialog box, in the **Name** box, type **stolenvehicledata**, and then click **OK**.
