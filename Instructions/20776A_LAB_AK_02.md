...
7. On the **Build** menu, click **Build Solution**.
8. Verify that the app compiles successfully, and then click **Local Machine** (Start). The app displays a map (of London), but not the positions of any patrol cars yet.
