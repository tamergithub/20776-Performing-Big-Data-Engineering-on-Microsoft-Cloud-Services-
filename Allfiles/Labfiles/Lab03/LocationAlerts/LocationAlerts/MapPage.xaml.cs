...
namespace LocationAlerts
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private string servicebusEndpoint = string.Empty, queueName = string.Empty, cameraQueueName = string.Empty, sharedAccessKeyName = string.Empty, sharedAccessKey = string.Empty;
        private QueueClient queueClient = null, cameraQueueClient = null;
