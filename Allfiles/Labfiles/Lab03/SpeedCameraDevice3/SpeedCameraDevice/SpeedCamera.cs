...
namespace SpeedCameraDevice
{
    class SpeedCamera
    {
        ...
        private bool jammed;
        private DateTime trainingRunTime = DateTime.UtcNow;
        private Boolean isTrainingRun = false;
        ...
        public SpeedCamera(string eventHubName, int deviceID, string cameraName, double positionLat, double positionLong, bool trainingRun)
        {
            ...
            this.isTrainingRun = trainingRun;
            this.causeTrafficJams = !this.isTrainingRun;
