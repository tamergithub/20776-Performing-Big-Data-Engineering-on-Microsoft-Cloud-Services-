...
namespace PatrolCar
{
    class PatrolCarsDriver
    {
        ...
        public PatrolCarsDriver(string serviceBusConnectionString, string topicName, string subscriptionName, string connectionString, string iotHubUri, int numCars, double latNorth, double latSouth, 
        ...
        public void Run(CancellationToken token)
        {
            ...
            for (int carNum = 0; carNum < this.numCars; carNum++)
            {
                ...
                var car = new PatrolCar(this.serviceBusConnectionString, this.topicName, this.subscriptionName, this.connectionString, this.iotHubUri, carNum, carName, carLatPosition, carLongPosition, 
